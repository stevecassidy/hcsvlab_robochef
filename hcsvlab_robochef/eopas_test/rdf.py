...
PARADISECNS = corpus_property_namespace(EOPAS_TEST)
...
paradisecMap = MetadataMapper(EOPAS_TEST, speakerMap=paradisecSpeakerMap, documentMap = get_generic_doc_mapper())
