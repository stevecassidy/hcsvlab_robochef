...
class UnitTest(unittest.TestCase):
    ...
    def testIngestW1A(self):
        ...
        self.ingest.setWrittenMetaData(self.corpus_basedir + "ICE/metadata")

        sourcepath = self.corpus_basedir + "ICE/standoff/written/W1A/W1A-001.txt"
    ...
    def testExtractionOfIceWrittenMetaDataWithPostAlpha(self):
        self.ingest.setWrittenMetaDataFile(self.corpus_basedir + "ICE/metadata")
